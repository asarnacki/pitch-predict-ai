    ...
    >
      {(title || supportingText) && (
        <header className="space-y-1">
          ...
          {supportingText ? (
            <p className="text-[0.9rem] text-[color:var(--hig-color-label-secondary)]">
              {supportingText}
            </p>
          ) : null}
        </header>
    ...
    >
      {(label || optional || trailing) && (
        <header className="flex flex-wrap items-baseline gap-2">
          ...
          {trailing ? (
            <div className="ml-auto text-[0.9rem] text-[color:var(--hig-color-label-secondary)]">
              {trailing}
            </div>
          ) : null}
        </header>
      ...
      {description ? (
        <p className="text-[0.9rem] text-[color:var(--hig-color-label-tertiary)]">{description}</p>
      ) : null}
      {accessory ? <div className="text-[0.95rem] text-[color:var(--hig-color-label-secondary)]">{accessory}</div> : null}
