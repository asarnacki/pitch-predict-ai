    ...
    <div className="space-y-8 sm:space-y-9 lg:space-y-16">
      ...
      >
        <div className="flex items-center justify-between gap-2">
          ...
          <span className={getPercentageClasses('home', 'text-primary')}>
            {homePercent}%
          </span>
        </div>
        <div className={getContainerClasses()}>
          <div
            className={getBarClasses('home', 'bg-primary')}
      ...
      >
        <div className="flex items-center justify-between gap-2">
          ...
          <span className={getPercentageClasses('draw', 'text-blue-600 dark:text-blue-400')}>
            {drawPercent}%
          </span>
        </div>
        <div className={getContainerClasses()}>
          <div
            className={getBarClasses('draw', 'bg-blue-600 dark:bg-blue-400')}
      ...
      >
        <div className="flex items-center justify-between gap-2">
          ...
          <span className={getPercentageClasses('away', 'text-green-600 dark:text-green-400')}>
            {awayPercent}%
          </span>
        </div>
        <div className={getContainerClasses()}>
