...
export interface ApiErrorResponse {
  error: {
    ...
    details?: any // Optional validation details or additional context
  }
}
 ...
 */
export function isPredictionProbabilities(
  value: unknown
): value is PredictionProbabilities {
 ...
 */
export function isValidLeagueCode(
  value: unknown
): value is typeof LEAGUE_CODES[keyof typeof LEAGUE_CODES] {
  return Object.values(LEAGUE_CODES).includes(value as any)
}

/**
 * Type guard to check if a league name is valid
 */
export function isValidLeagueName(
  value: unknown
): value is typeof LEAGUE_NAMES[keyof typeof LEAGUE_NAMES] {
